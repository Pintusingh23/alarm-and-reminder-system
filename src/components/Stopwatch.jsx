...
const Stopwatch = () => {
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10 animate-slide-up">
            ...
            <div className="text-center mb-10">
                <div className="inline-flex items-center gap-3">
                    <div className="p-2.5 bg-white rounded-xl shadow-sm border border-teal-200">
                        <Timer className="text-teal-600" size={20} />
                    </div>
                    <div className="text-left">
                        <h2 className="text-xl font-extrabold text-gray-800">Stopwatch</h2>
            ...
            <div className="flex justify-center mb-10">
                <div className="relative">
                    <svg width="280" height="280" viewBox="0 0 280 280" className="rotate-[-90deg]">
                        <circle cx="140" cy="140" r="120" fill="white" stroke="#e5e7eb" strokeWidth="8" />
                        <circle
                            cx="140" cy="140" r="120"
                            fill="none"
                            stroke="url(#swGradient)"
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        <div className="text-xl text-gray-400 mt-1 font-light">
                            .{ms}
                        </div>
                        <div className={`mt-3 text-[9px] font-bold uppercase tracking-[0.2em] px-4 py-1 rounded-full border ${
                            running
            ...
            <div className="flex justify-center gap-5 mb-10">
                ...
                <button
                    onClick={handleLap}
                    disabled={!running}
                    className="flex flex-col items-center gap-1.5 w-20 h-20 p-4 rounded-2xl bg-white border border-gray-200 shadow-sm transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed text-gray-600 hover:text-teal-600 hover:border-teal-300 hover:shadow-md"
                >
                    <Flag size={18} />
                    <span className="text-[9px] font-bold tracking-[0.2em]">LAP</span>
                </button>
                ...
                <button
                    onClick={handleStartStop}
                    className={`flex flex-col items-center gap-1.5 w-24 h-24 rounded-2xl font-bold text-white shadow-md transition-all duration-300 hover:scale-[1.05] ${
                        running
                ...
                <button
                    onClick={handleReset}
                    disabled={elapsed === 0}
                    className="flex flex-col items-center gap-1.5 w-20 h-20 p-4 rounded-2xl bg-white border border-gray-200 shadow-sm transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed text-gray-600 hover:text-red-600 hover:border-red-300 hover:shadow-md"
                >
                    <RotateCcw size={18} />
                    <span className="text-[9px] font-bold tracking-[0.2em]">RESET</span>
                </button>
                ...
                <div className="bg-white rounded-2xl overflow-hidden shadow-md border border-orange-100">
                    ...
                    <div className="divide-y divide-gray-100 max-h-56 overflow-y-auto">
                        {laps.map(lap => {
                            ...
                            return (
                                <div key={lap.id} className="flex items-center justify-between px-5 py-2.5 hover:bg-gray-50">
                                    <div className="flex items-center gap-3">
                                        <span className="text-gray-500 text-[10px] font-bold w-6">
                                            #{lap.id}
                                        </span>
                                    ...
                                    <span className={`text-sm font-bold ${
                                        ...
                                        {d}.<span className="text-gray-400">{m}</span>
                                    </span>
                                </div>
                            );
                        })}
